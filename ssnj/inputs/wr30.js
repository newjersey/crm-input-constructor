...
exports.addWR30Data = exports.init = exports.WR30_MAP = void 0;
const fs = require('fs');
const neatCsv = require('neat-csv');
exports.WR30_MAP = new Map();
...
async function init(path, notFoundPath) {
    ...
    (await neatCsv(raw, {
        ...
        if (!exports.WR30_MAP.has(ein)) {
            exports.WR30_MAP.set(ein, []);
        }
        const wageRecords = exports.WR30_MAP.get(ein);
        const wageRecord = {
...
function addWR30Data(application) {
    const wr30 = {
        ...
        wageRecords: exports.WR30_MAP.get(application.Business_TIN) || [],
    };
