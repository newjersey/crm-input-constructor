...
function getWr30ReportingComments(app) {
    ...
    if (award_size_1.grantPhase1AmountApproved(app)) {
        comments.push(`Award basis of ${util_1.formatDollars(award_size_1.awardBasis(app))} reduced by ${util_1.formatDollars(award_size_1.grantPhase1AmountApproved(app))} of Grant Phase 1 funding (${(_a = app.grantPhase1) === null || _a === void 0 ? void 0 : _a['OLA']}).`);
    }
...
function getEligibleOpportunityZoneValue(app) {
    if (typeof app.policyMap === 'undefined' ||
        app.policyMap.eligibilityStatus === policy_map_1.EligibilityStatus.NA ||
        app.policyMap.eligibilityStatus === policy_map_1.EligibilityStatus.Not_Found) {
        return types.EligibleOpportunityZoneValues.Not_Found;
    }
    const status = app.policyMap.eligibilityStatus;
    switch (status) {
        case policy_map_1.EligibilityStatus.Eligible:
