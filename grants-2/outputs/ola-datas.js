...
function generateOlaDatas(app) {
    ...
    try {
        const olaDatas = {
            ...
            Product: {
                DevelopmentOfficer: '',
                ServicingOfficerId: helpers_1.getServicingOfficer(app),
            ...
            Covid19Impacts: {
                ...
                Grant1applicationID: ((_b = app.grantPhase1) === null || _b === void 0 ? void 0 : _b['OLA Application ID ']) || null,
                ...
                ActualRevenue2019: helpers_1.value(app.RevenueComparison_MarchAprilMay2019),
                ActualRevenue2020: helpers_1.value(app.RevenueComparison_MarchAprilMay2020),
            ...
            OtherCovid19Assistance_CVSBGR: {
                ...
                ProgramDescription: `OLA Application ID: ${(_h = app.grantPhase1) === null || _h === void 0 ? void 0 : _h['OLA Application ID ']}`,
